...
var OpenIdOAuth2Strategy = require('../lib/strategy');

chai.use(chaiPassport);

describe('Strategy', function() {
  describe('constructed', function() {
    var strategy = new OpenIdOAuth2Strategy(
      {
  ...
  describe('errors', function() {
    it('should fail if missing all options', function() {
      expect(function() {
        new OpenIdOAuth2Strategy({}, function() {});
      }).to.throw(Error);
    });
  ...
  describe('authorizationParams', function() {
    beforeEach(function() {
      this.strategy = new OpenIdOAuth2Strategy(
        {
          authorizationURL: 'https://test.com/auth',
          tokenURL: 'https://test.com/token',
          userProfileURL: 'https://test.com/userinfo',
